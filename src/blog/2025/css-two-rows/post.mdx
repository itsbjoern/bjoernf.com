...
<Example editable content="Content that is much longer and will break because the container is restricted in width" contentStyle={{ width: "200px" }} />

---

As mentioned before, if the width-controlling row is animated, it will also animate the truncation of the other row:
<Example contentStyle={{ width: "100px", backgroundColor: "#a7b1ff" }} contentId="animatedContent" />
<br />
...
<script>{`
  ...
  button.addEventListener("click", function() {
    content.style.width = content.style.width === "100px" ? "300px" : "100px";
  });
`}</script>
