...
It was a satisfying project to work on. Solving real problems for someone you know, and learning a lot about a format that most people happily treat as a black box. If you have a similar use case — templated PDFs, local data, design-sensitive output — <Ref text="PDF Interpolator" href="https://github.com/itsbjoern/pdf-interpolator" /> might be worth a look. It's available for Windows, macOS, and Linux.
