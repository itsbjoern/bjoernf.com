from .api import index, blog, rss, admin
...
def setup_routes(app):
  ...
  app.router.add_post('/admin/index/changePassword', admin.index.change_password)
  ...
  app.router.add_delete('/admin/blog/posts/{id}/draft', admin.blog.delete_draft)
  app.router.add_post('/admin/blog/posts/{id}/publish', admin.blog.publish)
  app.router.add_post('/admin/blog/posts/{id}/unpublish', admin.blog.unpublish)
  ...
  app.router.add_get('/{tail:.*}', index.not_found)
